(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            ...
            var sliderCredit = document.getElementById("slider-credit");
            if (sliderCredit) nouislider.create(sliderCredit, {
                start: [ 0, 3 ],
                connect: true,
                format: {
                    from: function(value) {
            ...
            var sliderPercent = document.getElementById("slider-percent");
            if (sliderPercent) nouislider.create(sliderPercent, {
                start: [ 0, 29.99 ],
                connect: true,
                range: {
                    min: 20,
            ...
            var rangeSliderValueElement = document.querySelector(".popup-range__count");
            var rangeSliderCreditValue = document.querySelector(".text-mounth");
            var rangeSliderCreditValueText = document.querySelector(".text-inner");
            var rangeSliderCreditValuePercent = document.querySelector(".percent-inner");
            slider.noUiSlider.on("update", (function(values, handle) {
                rangeSliderValueElement.innerHTML = values[handle];
            }));
            if (sliderCredit) sliderCredit.noUiSlider.on("update", (function(values, handle) {
                rangeSliderCreditValue.innerHTML = values[handle];
                rangeSliderCreditValueText.innerHTML = values[handle];
            }));
            if (sliderPercent) sliderPercent.noUiSlider.on("update", (function(values, handle) {
                rangeSliderCreditValuePercent.innerHTML = values[handle];
            }));
        }
        rangeInit();
        ...
        function initSliders() {
            if (document.querySelector(".diagnostics__slider")) new core(".diagnostics__slider", {
            ...
            if (document.querySelector(".individual__slider")) new core(".individual__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".mainscreen-trade__slider")) new core(".mainscreen-trade__slider", {
            ...
            if (document.querySelector(".our-services__slider")) new core(".our-services__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".available-cars__slider")) new core(".available-cars__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
        ...
        document.querySelector(".select_type-select");
        document.querySelector(".popup_show");
        document.querySelector(".popup-show");
        document.querySelector(".popup__content");
        const popupItemType = document.querySelectorAll(".popup-type__item");
        const popupItemCity = document.querySelectorAll(".popup-city__item");
        document.querySelectorAll(".popup-type__description");
        document.querySelectorAll("popup-city__name");
        const typeOption = document.querySelector(".type");
        const testOp = document.querySelector(".select__options .type");
        const cityOption = document.querySelector(".city");
        const cityOp = document.querySelector(".select__options .city");
        popupItemType.forEach((function(item, i, arr) {
            item.addEventListener("click", (function(e) {
                const popupItemTypeChildren = item.lastElementChild;
                let content = popupItemTypeChildren.innerHTML;
                typeOption.innerHTML = content;
                testOp.innerHTML = content;
            }));
        }));
        popupItemCity.forEach((function(item, i, arr) {
            item.addEventListener("click", (function(e) {
                const popupItemCityChildren = item.firstElementChild;
                let contentCity = popupItemCityChildren.innerHTML;
                cityOption.innerHTML = contentCity;
                cityOp.innerHTML = contentCity;
            }));
        }));
        document.addEventListener("click", (function(e) {
            let targetElement = e.target;
            ...
            if (targetElement.closest(".select_type-select")) document.documentElement.classList.add("type-active");
            if (targetElement.closest(".select_city-select")) document.documentElement.classList.add("city-active");
        }));
        const partnersSlideItems = document.querySelectorAll(".partners__slide").length;
        if (partnersSlideItems) if (partnersSlideItems > 6) document.querySelector(".partners").classList.add("_pagination-active");
        isWebp();
        menuInit();
        spollers();
        tabs();
